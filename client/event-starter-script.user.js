...
(() => {
        ...
        <section class="view" data-view="create">
          <form data-role="create-form">
            <div class="form-grid">
              ...
              <label>Session password<input name="password" type="password" minlength="8" maxlength="32" autocomplete="new-password"></label>
              <label class="span-2">Event password<input name="eventPassword" type="password" autocomplete="off"></label>
            </div>
            <div class="actions">
  ...
  async function onCreateSession(event) {
    ...
    const eventPassword = String(data.get("eventPassword") || "");
    ...
    try {
      ...
      if (eventPassword) payload.eventPassword = eventPassword;
      ...
      ui.createForm.elements.eventPassword.value = "";
